...
ActiveRecord::Schema.define(version: 2020_11_09_075144) do
  ...
  create_table "companies", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.string "office_url", null: false
    t.string "staff_lastname_kana", null: false
    t.string "staff_firstname_kana", null: false
    t.text "detail"
  ...
  create_table "user_relations", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["company_id"], name: "index_user_relations_on_company_id"
